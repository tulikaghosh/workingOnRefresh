...
export class AuthService {
  ...
  register(first_name: string, last_name: string, username: string, email: string, password: string, address: string, contact: string, userImage: string): Observable<any> {
